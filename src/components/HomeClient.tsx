    ...
    <div className="flex flex-col min-h-screen bg-[#1E1E24] text-[#F5F5F7]">
      <div ref={containerRef} className="relative w-full h-screen overflow-hidden border-b border-[#2C2C35]">
        ...
        <div ref={v2Ref} className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-0">
          ...
          <div className="absolute max-w-4xl text-center px-8">
            <div className="bg-[#1E1E24]/90 backdrop-blur-md p-8 border border-[#2C2C35] font-mono leading-relaxed space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold uppercase text-[#0A84FF]">
                WHY BESPOKE CODE OUTPERFORMS STANDARD WEB DEVELOPMENT TEMPLATES
              </h2>
              <p className="text-lg text-[#F5F5F7]">
                Standard web development templates introduce up to 70% unnecessary script bloat, dragging down client performance. Devfinity eliminates this by engineering clean Next.js server-rendered applications, ensuring zero layout shifting and sub-200ms API interaction latency under high transactional strain.
              </p>
            </div>
          </div>
        </div>
